...
def evaluate_predictions(filename):
    ...
    with open(filename, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            reasoning = obj.get('reasoning', '')  # 提取判断依据
            ...
            if prediction == 1:  # 只在有漏洞的情况下评估CWE类型
                ...
                if reasoning:  # 记录判断依据
                    ...
                    logging.warning(f"未找到预测的漏洞判断依据: 文件名 {obj.get('file_name', '未知')}")
...
if __name__ == '__main__':
    filename = '../../result/deepseek-coder_API_CoT_CWE_answers.json'
